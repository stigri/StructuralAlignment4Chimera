...
#include "read_seq_i.h"
    ...
    "$Id: lsqf.c,v 1.5 2011/09/07 15:04:55 margraf Exp $";
...
double
tm_score ( struct pair_set *pairset, struct coord *r1, struct coord *r2 )
{
    double tmscore = 0.0;
    double dO = 0.0;
    double di = 0.0;
    ...
    tmscore = tmscore / ln;
    /* err_printf("tm_score", "ln = %d, lt = %d, dO = %f, tmscr = %f \n", ln, lt, dO, tmscore); */
	return(tmscore);
}


double
tm_score_s ( struct pair_set *pairset, struct coord *r1, struct coord *r2 )
{
    double tmscore = 0.0;
    double dO = 0.0;
    double di = 0.0;
